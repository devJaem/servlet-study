...
<body>
    ...
    <form action="formdata" method="post">
        ...
        <br>
        <label>취미 :</label>
        <input type="checkbox" id="movie2" value="movie" name="hobbies"><label for="movie">영화</label>
        <input type="checkbox" id="music2" value="music" name="hobbies"><label for="music">음악</label>
        <input type="checkbox" id="sleep2" value="sleep" name="hobbies"><label for="sleep">취침</label>
        <br>
